    ...
    <section class="section dashboard">
        <div class="row">
            <div class="card text-center">
                            ...
                            <div class="modal-content">
                                ...
                                <form id="budaya_form" method="POST"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="deskripsi">Nopol </label>
                                            <input type="text" class="form-control" name="deskripsi" id="deskripsi" required>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="lokasi">Tahun Beli </label>
                                            <input type="number" class="form-control" name="lokasi"
                                                id="lokasi" min="1988" max="{{ date('Y') }}" required>
                                        </div>

                                        <div class="form-group mb-3">
                                            <label for="tahun_ditemukan">Tahun Jual</label>
                                            <input type="number" class="form-control" name="tahun_ditemukan"
                                                id="tahun_ditemukan" min="2002" max="{{ date('Y') }}" required>
                                        </div>
                ...
                <h5 class="card-title">List Pembelian Mobil</h5>
                {{-- data Pendidikan --}}
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            {{--ini perulangan untuk tampilan lsit--}}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="/otomotif.destroy/{{$item->id}}" method="GET"
                                        class="d-inline">
                                        @csrf
                                        {{-- @method('DELETE') --}}
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form id="edit_budaya_form" method="POST"
                                            action="{{url('/otomotif.update')}}">
                                            @csrf
                                            {{-- @method('PUT') --}}
                                            <div class="modal-body">

                                                <div class="form-group mb-3">
                                                    <input type="hidden" class="form-control" name="id" id="nama"
